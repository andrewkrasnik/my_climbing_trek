...
import 'core/injectable_module.dart' as _i229;
...
import 'features/authentication/domain/repositories/auth_repository.dart'
    as _i85;
import 'features/authentication/domain/usecases/auth_get_user.dart' as _i191;
import 'features/authentication/domain/usecases/auth_login.dart' as _i192;
import 'features/authentication/domain/usecases/auth_logout.dart' as _i193;
...
import 'features/hall_climbing/domain/usecases/hall_route_to_archive.dart'
    as _i130;
import 'features/hall_climbing/domain/usecases/new_hall_route.dart' as _i157;
...
import 'features/ice_climbing/domain/repositories/ice_treanings_repository.dart'
    as _i139;
import 'features/ice_climbing/domain/usecases/delete_ice_attempt.dart' as _i202;
import 'features/ice_climbing/domain/usecases/finish_ice_attempt.dart' as _i208;
...
import 'features/ice_climbing/domain/usecases/load_sectors_usecase.dart'
    as _i147;
import 'features/ice_climbing/domain/usecases/new_ice_attempt.dart' as _i159;
import 'features/ice_climbing/domain/usecases/new_ice_treaning.dart' as _i160;
...
import 'features/mountaineering/domain/usecases/get_mountain_routes.dart'
    as _i117;
import 'features/mountaineering/domain/usecases/get_mountaints.dart' as _i118;
...
import 'features/rock_climbing/domain/usecases/load_rock_districts.dart'
    as _i144;
import 'features/rock_climbing/domain/usecases/load_rock_routes.dart' as _i145;
import 'features/rock_climbing/domain/usecases/load_rock_sectors.dart' as _i146;
import 'features/rock_climbing/domain/usecases/new_rock_attempt.dart' as _i161;
import 'features/rock_climbing/domain/usecases/new_rock_treaning.dart' as _i162;
...
import 'features/settings/domain/usecases/load_places.dart' as _i143;
...
import 'features/settings/domain/usecases/save_treanings_settings.dart'
    as _i173;
import 'features/settings/presentation/cubit/settings_cubit.dart' as _i175;
...
import 'features/traveling/domain/usecases/get_planed_travels_usecase.dart'
    as _i119;
import 'features/traveling/domain/usecases/get_travels_usecase.dart' as _i127;
...
import 'features/traveling/presentation/cubit/travels/travels_cubit.dart'
    as _i183;
import 'features/treanings/domain/usecases/delete_treaning.dart' as _i203;
import 'features/treanings/domain/usecases/get_all_treanings.dart' as _i210;
import 'features/treanings/presentation/cubit/treanings_cubit.dart' as _i223;
...
import 'features/trekking/domain/usecases/current_trekking_path_usecase.dart'
    as _i98;
import 'features/trekking/domain/usecases/get_trekking_regions.dart' as _i128;
import 'features/trekking/domain/usecases/get_treks.dart' as _i129;
import 'features/trekking/domain/usecases/previos_trekking_path_usecase.dart'
    as _i164;
import 'features/trekking/domain/usecases/start_trek_usecase.dart' as _i176;
...
import 'features/trekking/presentation/bloc/trekking_regions/trekking_regions_cubit.dart'
    as _i185;
import 'features/trekking/presentation/bloc/treks/treks_cubit.dart' as _i186;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i104.DeleteTechniqueTreaningUseCase>(() =>
      _i104.DeleteTechniqueTreaningUseCase(
          gh<_i55.TechniqueTreaningsRepository>()));
  gh.lazySingleton<_i105.EditTechniqueItemUseCase>(() =>
      _i105.EditTechniqueItemUseCase(gh<_i55.TechniqueTreaningsRepository>()));
  gh.lazySingleton<_i106.FinishRockAttempt>(
      () => _i106.FinishRockAttempt(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i107.FinishRockTreaning>(
      () => _i107.FinishRockTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i108.FinishStrengthTreaning>(() =>
      _i108.FinishStrengthTreaning(
          strengthTreaningsRepository: gh<_i51.StrengthTreaningsRepository>()));
  gh.lazySingleton<_i109.FinishTechniqueTreaningUseCase>(() =>
      _i109.FinishTechniqueTreaningUseCase(
          gh<_i55.TechniqueTreaningsRepository>()));
  gh.lazySingleton<_i110.GetCardioTreanings>(() => _i110.GetCardioTreanings(
      cardioTreaningsRepository: gh<_i89.CardioTreaningsRepository>()));
  gh.lazySingleton<_i111.GetClimbingHallRoures>(
      () => _i111.GetClimbingHallRoures(gh<_i91.ClimbingHallRepository>()));
  gh.lazySingleton<_i112.GetCurrentRockTreaning>(
      () => _i112.GetCurrentRockTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i113.GetCurrentStrengthTreaning>(() =>
      _i113.GetCurrentStrengthTreaning(
          strengthTreaningsRepository: gh<_i51.StrengthTreaningsRepository>()));
  gh.lazySingleton<_i114.GetLastCardioTreaning>(() =>
      _i114.GetLastCardioTreaning(
          cardioTreaningsRepository: gh<_i89.CardioTreaningsRepository>()));
  gh.lazySingleton<_i115.GetLastRockTreaning>(
      () => _i115.GetLastRockTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i116.GetMountainRegions>(
      () => _i116.GetMountainRegions(gh<_i20.MountainRegionsRepository>()));
  gh.lazySingleton<_i117.GetMountainRoutes>(
      () => _i117.GetMountainRoutes(gh<_i20.MountainRegionsRepository>()));
  gh.lazySingleton<_i118.GetMountains>(
      () => _i118.GetMountains(gh<_i20.MountainRegionsRepository>()));
  gh.lazySingleton<_i119.GetPlanedTravelsUsecase>(
      () => _i119.GetPlanedTravelsUsecase(gh<_i64.TravelRepository>()));
  gh.lazySingleton<_i120.GetPreviosStrengthTreaning>(() =>
      _i120.GetPreviosStrengthTreaning(
          strengthTreaningsRepository: gh<_i51.StrengthTreaningsRepository>()));
  gh.lazySingleton<_i121.GetRockRouteAttempts>(
      () => _i121.GetRockRouteAttempts(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i122.GetRockRouteStatistic>(
      () => _i122.GetRockRouteStatistic(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i123.GetStrengthExercises>(() => _i123.GetStrengthExercises(
      strengthExerciseRepository: gh<_i47.StrengthExerciseRepository>()));
  gh.lazySingleton<_i124.GetStrengthTreanings>(() => _i124.GetStrengthTreanings(
      strengthTreaningsRepository: gh<_i51.StrengthTreaningsRepository>()));
  gh.lazySingleton<_i125.GetTechniqueGroupsUsecase>(
      () => _i125.GetTechniqueGroupsUsecase(gh<_i59.TechniquesRepository>()));
  gh.lazySingleton<_i126.GetTechniquesUsecase>(
      () => _i126.GetTechniquesUsecase(gh<_i59.TechniquesRepository>()));
  gh.lazySingleton<_i127.GetTravelsUsecase>(
      () => _i127.GetTravelsUsecase(gh<_i64.TravelRepository>()));
  gh.lazySingleton<_i128.GetTrekkingRegions>(
      () => _i128.GetTrekkingRegions(gh<_i72.TrekkingRepository>()));
  gh.lazySingleton<_i129.GetTreks>(
      () => _i129.GetTreks(gh<_i72.TrekkingRepository>()));
  gh.lazySingleton<_i130.HallRouteToArchive>(() =>
      _i130.HallRouteToArchive(repository: gh<_i91.ClimbingHallRepository>()));
  gh.lazySingleton<_i131.HallTreaningDataSource>(
      () => _i132.LocalHallTreaningDataSource(gh<_i14.LocalDBDatasource>()));
  gh.lazySingleton<_i133.HallTreaningRepository>(
      () => _i134.HallTreaningRepositoryImpl(
            dataSource: gh<_i131.HallTreaningDataSource>(),
            hallDataSource: gh<_i3.ClimbingHallDataSource>(),
          ));
  gh.lazySingleton<_i135.IceRegionsRepository>(
      () => _i136.IceRegionsRepositoryImpl(
            gh<_i9.IceRegionsDataSource>(),
            gh<_i11.IceRegionsRemoteDataSource>(),
            gh<_i22.NetworkInfo>(),
          ));
  gh.lazySingleton<_i137.IceTreaningsDataSource>(
      () => _i138.LocalIceTreaningsDataSource(gh<_i14.LocalDBDatasource>()));
  gh.lazySingleton<_i139.IceTreaningsRepository>(() =>
      _i140.IceTreaningsRepositoryImpl(gh<_i137.IceTreaningsDataSource>()));
  gh.lazySingleton<_i141.LastHallTreaning>(
      () => _i141.LastHallTreaning(gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i142.LoadDistrictsUseCase>(() => _i142.LoadDistrictsUseCase(
      iceRegionsRepository: gh<_i135.IceRegionsRepository>()));
  gh.lazySingleton<_i143.LoadPlaces>(
      () => _i143.LoadPlaces(gh<_i27.PlacesRepository>()));
  gh.lazySingleton<_i144.LoadRockDistricts>(
      () => _i144.LoadRockDistricts(gh<_i35.RockRegionsRepository>()));
  gh.lazySingleton<_i145.LoadRockRoutes>(
      () => _i145.LoadRockRoutes(gh<_i35.RockRegionsRepository>()));
  gh.lazySingleton<_i146.LoadRockSectors>(
      () => _i146.LoadRockSectors(gh<_i35.RockRegionsRepository>()));
  gh.lazySingleton<_i147.LoadSectorsUseCase>(() => _i147.LoadSectorsUseCase(
      iceRegionsRepository: gh<_i135.IceRegionsRepository>()));
  gh.lazySingleton<_i148.LoadSimpleSettingsUsecase>(
      () => _i148.LoadSimpleSettingsUsecase(gh<_i43.SettingsRepository>()));
  gh.lazySingleton<_i149.LoadTreaningsSettings>(
      () => _i149.LoadTreaningsSettings(gh<_i43.SettingsRepository>()));
  gh.lazySingleton<_i150.LocalAscensionDataSource>(
      () => _i151.DriftLocalAscensionDataSource(gh<_i14.LocalDBDatasource>()));
  gh.factory<_i152.MountainRegionsCubit>(
      () => _i152.MountainRegionsCubit(gh<_i116.GetMountainRegions>()));
  gh.factory<_i153.MountainRoutesCubit>(
      () => _i153.MountainRoutesCubit(gh<_i117.GetMountainRoutes>()));
  gh.factory<_i154.MountainsCubit>(
      () => _i154.MountainsCubit(gh<_i118.GetMountains>()));
  gh.lazySingleton<_i155.NewHallAttempt>(() => _i155.NewHallAttempt(
      treaningRepository: gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i156.NewHallAttemptFromRoute>(() =>
      _i156.NewHallAttemptFromRoute(
          hallTreaningRepository: gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i157.NewHallRoute>(() => _i157.NewHallRoute(
      climbingHallRepository: gh<_i91.ClimbingHallRepository>()));
  gh.lazySingleton<_i158.NewHallTreaning>(() => _i158.NewHallTreaning(
      treaningRepository: gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i159.NewIceAttempt>(
      () => _i159.NewIceAttempt(gh<_i139.IceTreaningsRepository>()));
  gh.lazySingleton<_i160.NewIceTreaning>(() => _i160.NewIceTreaning(
        iceTreaningsRepository: gh<_i139.IceTreaningsRepository>(),
        iceRegionsRepository: gh<_i135.IceRegionsRepository>(),
      ));
  gh.lazySingleton<_i161.NewRockAttempt>(
      () => _i161.NewRockAttempt(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i162.NewRockTreaning>(
      () => _i162.NewRockTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i163.PreviosTechniqueTreaningUseCase>(() =>
      _i163.PreviosTechniqueTreaningUseCase(
          gh<_i55.TechniqueTreaningsRepository>()));
  gh.lazySingleton<_i164.PreviosTrekkingPathUsecase>(() =>
      _i164.PreviosTrekkingPathUsecase(gh<_i68.TrekkingPathRepository>()));
  gh.factory<_i165.RockDistrictsCubit>(
      () => _i165.RockDistrictsCubit(gh<_i144.LoadRockDistricts>()));
  gh.factory<_i166.RockRoutesCubit>(() => _i166.RockRoutesCubit(
        gh<_i145.LoadRockRoutes>(),
        gh<_i122.GetRockRouteStatistic>(),
      ));
  gh.lazySingleton<_i167.RockSectorToTreaning>(
      () => _i167.RockSectorToTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.factory<_i168.RockSectorsCubit>(
      () => _i168.RockSectorsCubit(gh<_i146.LoadRockSectors>()));
  gh.factory<_i169.RockTreaningCubit>(() => _i169.RockTreaningCubit(
        gh<_i162.NewRockTreaning>(),
        gh<_i167.RockSectorToTreaning>(),
        gh<_i161.NewRockAttempt>(),
        gh<_i106.FinishRockAttempt>(),
        gh<_i107.FinishRockTreaning>(),
        gh<_i115.GetLastRockTreaning>(),
        gh<_i112.GetCurrentRockTreaning>(),
        gh<_i122.GetRockRouteStatistic>(),
        gh<_i101.DeleteRockAttempt>(),
      ));
  gh.lazySingleton<_i170.SaveCardioTreaning>(() => _i170.SaveCardioTreaning(
      cardioTreaningsRepository: gh<_i89.CardioTreaningsRepository>()));
  gh.lazySingleton<_i171.SaveSimpleSettingsUsecase>(
      () => _i171.SaveSimpleSettingsUsecase(gh<_i43.SettingsRepository>()));
  gh.lazySingleton<_i172.SaveStrengthExercise>(() => _i172.SaveStrengthExercise(
      strengthExerciseRepository: gh<_i47.StrengthExerciseRepository>()));
  gh.lazySingleton<_i173.SaveTreaningsSettings>(
      () => _i173.SaveTreaningsSettings(gh<_i43.SettingsRepository>()));
  gh.lazySingleton<_i174.SelectToUseStrengthExercise>(() =>
      _i174.SelectToUseStrengthExercise(
          strengthExerciseRepository: gh<_i47.StrengthExerciseRepository>()));
  gh.lazySingleton<_i175.SettingsCubit>(() => _i175.SettingsCubit(
        gh<_i149.LoadTreaningsSettings>(),
        gh<_i173.SaveTreaningsSettings>(),
        gh<_i143.LoadPlaces>(),
        gh<_i148.LoadSimpleSettingsUsecase>(),
        gh<_i171.SaveSimpleSettingsUsecase>(),
      ));
  gh.lazySingleton<_i176.StartTrekUsecase>(
      () => _i176.StartTrekUsecase(gh<_i68.TrekkingPathRepository>()));
  gh.factory<_i177.StrengthExercisesCubit>(() => _i177.StrengthExercisesCubit(
        gh<_i123.GetStrengthExercises>(),
        gh<_i172.SaveStrengthExercise>(),
        gh<_i174.SelectToUseStrengthExercise>(),
        gh<_i102.DeleteStrengthExercise>(),
      ));
  gh.factory<_i178.StrengthTrainingCubit>(() => _i178.StrengthTrainingCubit(
        getCurrentStrengthTreaning: gh<_i113.GetCurrentStrengthTreaning>(),
        getPreviosStrengthTreaning: gh<_i120.GetPreviosStrengthTreaning>(),
        ...
        finishStrengthTreaning: gh<_i108.FinishStrengthTreaning>(),
        deleteRepetitionForStrengthTreaning:
            gh<_i100.DeleteRepetitionForStrengthTreaning>(),
      ));
  gh.factory<_i179.StrengthTrainingsCubit>(() => _i179.StrengthTrainingsCubit(
        gh<_i124.GetStrengthTreanings>(),
        gh<_i103.DeleteStrengthTreaning>(),
      ));
  gh.factory<_i180.TechniqueGroupsCubit>(
      () => _i180.TechniqueGroupsCubit(gh<_i125.GetTechniqueGroupsUsecase>()));
  gh.factory<_i181.TechniqueTreaningCubit>(() => _i181.TechniqueTreaningCubit(
        gh<_i78.AddTechniqueTreaningUseCase>(),
        gh<_i163.PreviosTechniqueTreaningUseCase>(),
        gh<_i96.CurrentTechniqueTreaningUseCase>(),
        gh<_i77.AddTechniqueToTreaningUseCase>(),
        gh<_i109.FinishTechniqueTreaningUseCase>(),
        gh<_i105.EditTechniqueItemUseCase>(),
      ));
  gh.factory<_i182.TechniquesCubit>(
      () => _i182.TechniquesCubit(gh<_i126.GetTechniquesUsecase>()));
  gh.factory<_i183.TravelsCubit>(() => _i183.TravelsCubit(
        gh<_i127.GetTravelsUsecase>(),
        gh<_i119.GetPlanedTravelsUsecase>(),
        gh<_i79.AddTravelUsecase>(),
      ));
  gh.factory<_i184.TrekkingCubit>(() => _i184.TrekkingCubit(
        gh<_i98.CurrentTrekkingPathUsecase>(),
        gh<_i164.PreviosTrekkingPathUsecase>(),
        gh<_i176.StartTrekUsecase>(),
        gh<_i80.AddTrekEventUsecase>(),
        gh<_i93.ContinueTrekUsecase>(),
      ));
  gh.factory<_i185.TrekkingRegionsCubit>(
      () => _i185.TrekkingRegionsCubit(gh<_i128.GetTrekkingRegions>()));
  gh.factory<_i186.TreksCubit>(() => _i186.TreksCubit(gh<_i129.GetTreks>()));
  gh.lazySingleton<_i187.AllClimbingHalls>(
      () => _i187.AllClimbingHalls(gh<_i91.ClimbingHallRepository>()));
  gh.lazySingleton<_i188.AllHallTreanings>(
      () => _i188.AllHallTreanings(gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i189.AscensionRepository>(() =>
      _i190.AscensionRepositoryImpl(gh<_i150.LocalAscensionDataSource>()));
  gh.factory<_i191.AuthGetUser>(
      () => _i191.AuthGetUser(authRepository: gh<_i85.AuthRepository>()));
  gh.factory<_i192.AuthLogin>(
      () => _i192.AuthLogin(authRepository: gh<_i85.AuthRepository>()));
  gh.factory<_i193.AuthLogout>(
      () => _i193.AuthLogout(authRepository: gh<_i85.AuthRepository>()));
  gh.factory<_i194.AuthenticationCubit>(() => _i194.AuthenticationCubit(
        gh<_i192.AuthLogin>(),
        gh<_i193.AuthLogout>(),
        gh<_i191.AuthGetUser>(),
      ));
  gh.factory<_i195.CardioTreaningCubit>(() => _i195.CardioTreaningCubit(
        gh<_i114.GetLastCardioTreaning>(),
        gh<_i170.SaveCardioTreaning>(),
      ));
  gh.factory<_i196.CardioTreaningsCubit>(() => _i196.CardioTreaningsCubit(
        gh<_i110.GetCardioTreanings>(),
        gh<_i99.DeleteCardioTreaning>(),
        gh<_i170.SaveCardioTreaning>(),
      ));
  gh.factory<_i197.ClimbingHallsCubit>(() =>
      _i197.ClimbingHallsCubit(allClimbingHalls: gh<_i187.AllClimbingHalls>()));
  gh.lazySingleton<_i198.CurrentHallTreaning>(
      () => _i198.CurrentHallTreaning(gh<_i133.HallTreaningRepository>()));
  gh.factory<_i199.CurrentTravelCubit>(() => _i199.CurrentTravelCubit(
  ...
  gh.lazySingleton<_i201.DeleteHallTreaning>(() => _i201.DeleteHallTreaning(
      treaningRepository: gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i202.DeleteIceAttempt>(
      () => _i202.DeleteIceAttempt(gh<_i139.IceTreaningsRepository>()));
  gh.lazySingleton<_i203.DeleteTreaning>(() => _i203.DeleteTreaning(
        gh<_i133.HallTreaningRepository>(),
        gh<_i139.IceTreaningsRepository>(),
        ...
        gh<_i55.TechniqueTreaningsRepository>(),
        gh<_i189.AscensionRepository>(),
      ));
  gh.lazySingleton<_i204.EditAscensionEventUsecase>(
      () => _i204.EditAscensionEventUsecase(gh<_i189.AscensionRepository>()));
  gh.lazySingleton<_i205.FinishAscensionUsecase>(
      () => _i205.FinishAscensionUsecase(gh<_i189.AscensionRepository>()));
  gh.lazySingleton<_i206.FinishHallAttempt>(() => _i206.FinishHallAttempt(
      treaningRepository: gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i207.FinishHallTreaning>(() => _i207.FinishHallTreaning(
      treaningRepository: gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i208.FinishIceAttempt>(
      () => _i208.FinishIceAttempt(gh<_i139.IceTreaningsRepository>()));
  gh.lazySingleton<_i209.FinishIceTreaning>(() => _i209.FinishIceTreaning(
      iceTreaningsRepository: gh<_i139.IceTreaningsRepository>()));
  gh.lazySingleton<_i210.GetAllTreanings>(() => _i210.GetAllTreanings(
        gh<_i133.HallTreaningRepository>(),
        gh<_i139.IceTreaningsRepository>(),
        gh<_i51.StrengthTreaningsRepository>(),
        gh<_i89.CardioTreaningsRepository>(),
  ...
  gh.lazySingleton<_i211.GetAscensionUsecase>(
      () => _i211.GetAscensionUsecase(gh<_i189.AscensionRepository>()));
  gh.lazySingleton<_i212.GetCurrentIceTreaning>(() =>
      _i212.GetCurrentIceTreaning(
          iceTreaningsRepository: gh<_i139.IceTreaningsRepository>()));
  gh.lazySingleton<_i213.GetGymRouteStatistic>(
      () => _i213.GetGymRouteStatistic(gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i214.GetHallRouteAttempts>(() => _i214.GetHallRouteAttempts(
      repository: gh<_i133.HallTreaningRepository>()));
  gh.lazySingleton<_i215.GetLastIceTreaning>(() => _i215.GetLastIceTreaning(
      iceTreaningsRepository: gh<_i139.IceTreaningsRepository>()));
  gh.factory<_i216.HallRouteAttemptsCubit>(() => _i216.HallRouteAttemptsCubit(
      getHallRouteAttempts: gh<_i214.GetHallRouteAttempts>()));
  gh.factory<_i217.HallRouteCubit>(
      () => _i217.HallRouteCubit(gh<_i157.NewHallRoute>()));
  gh.factory<_i218.HallTreaningsCubit>(() => _i218.HallTreaningsCubit(
        allHallTreanings: gh<_i188.AllHallTreanings>(),
        deleteHallTreaning: gh<_i201.DeleteHallTreaning>(),
      ));
  gh.factory<_i219.HomePageCubit>(() =>
      _i219.HomePageCubit(allClimbingHalls: gh<_i187.AllClimbingHalls>()));
  gh.factory<_i220.IceDistrictsCubit>(() => _i220.IceDistrictsCubit(
      loadDistrictsUseCase: gh<_i142.LoadDistrictsUseCase>()));
  gh.lazySingleton<_i221.IceSectorToTreaning>(() => _i221.IceSectorToTreaning(
      iceTreaningsRepository: gh<_i139.IceTreaningsRepository>()));
  gh.factory<_i222.IceSectorsCubit>(() => _i222.IceSectorsCubit(
      loadSectorsUseCase: gh<_i147.LoadSectorsUseCase>()));
  gh.factory<_i223.TreaningsCubit>(() => _i223.TreaningsCubit(
        gh<_i210.GetAllTreanings>(),
        gh<_i203.DeleteTreaning>(),
      ));
  gh.lazySingleton<_i224.AddAscensionUsecase>(
      () => _i224.AddAscensionUsecase(gh<_i189.AscensionRepository>()));
  gh.factory<_i225.AscensionCubit>(() => _i225.AscensionCubit(
        gh<_i224.AddAscensionUsecase>(),
        gh<_i211.GetAscensionUsecase>(),
        gh<_i205.FinishAscensionUsecase>(),
        gh<_i204.EditAscensionEventUsecase>(),
      ));
  gh.factory<_i226.ClimbingHallCubit>(() => _i226.ClimbingHallCubit(
        gh<_i111.GetClimbingHallRoures>(),
        gh<_i130.HallRouteToArchive>(),
        gh<_i213.GetGymRouteStatistic>(),
      ));
  gh.factory<_i227.CurrentHallTreaningCubit>(
      () => _i227.CurrentHallTreaningCubit(
            newHallAttemptFromRoute: gh<_i156.NewHallAttemptFromRoute>(),
            newHallTreaning: gh<_i158.NewHallTreaning>(),
            newHallAttempt: gh<_i155.NewHallAttempt>(),
            currentHallTreaning: gh<_i198.CurrentHallTreaning>(),
            finishHallAttempt: gh<_i206.FinishHallAttempt>(),
            finishHallTreaning: gh<_i207.FinishHallTreaning>(),
            lastHallTreaning: gh<_i141.LastHallTreaning>(),
            deleteHallAttempt: gh<_i200.DeleteHallAttempt>(),
            getGymRouteStatistic: gh<_i213.GetGymRouteStatistic>(),
          ));
  gh.factory<_i228.CurrentIceTreaningCubit>(() => _i228.CurrentIceTreaningCubit(
        gh<_i160.NewIceTreaning>(),
        gh<_i221.IceSectorToTreaning>(),
        gh<_i159.NewIceAttempt>(),
        gh<_i208.FinishIceAttempt>(),
        gh<_i209.FinishIceTreaning>(),
        gh<_i212.GetCurrentIceTreaning>(),
        gh<_i215.GetLastIceTreaning>(),
        gh<_i202.DeleteIceAttempt>(),
      ));
  return getIt;
}

class _$InjectableModule extends _i229.InjectableModule {}

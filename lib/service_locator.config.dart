...
import 'features/hall_climbing/domain/usecases/hall_route_to_archive.dart'
    as _i140;
import 'features/hall_climbing/domain/usecases/new_hall_route.dart' as _i167;
...
import 'features/ice_climbing/domain/usecases/load_sectors_usecase.dart'
    as _i157;
import 'features/ice_climbing/domain/usecases/new_ice_attempt.dart' as _i169;
import 'features/ice_climbing/domain/usecases/new_ice_treaning.dart' as _i170;
...
import 'features/mountaineering/domain/usecases/get_mountain_routes.dart'
    as _i127;
import 'features/mountaineering/domain/usecases/get_mountaints.dart' as _i128;
...
import 'features/rock_climbing/domain/usecases/load_rock_districts.dart'
    as _i154;
import 'features/rock_climbing/domain/usecases/load_rock_routes.dart' as _i155;
import 'features/rock_climbing/domain/usecases/load_rock_sectors.dart' as _i156;
import 'features/rock_climbing/domain/usecases/new_rock_attempt.dart' as _i171;
import 'features/rock_climbing/domain/usecases/new_rock_treaning.dart' as _i172;
...
import 'features/settings/domain/usecases/load_places.dart' as _i153;
...
import 'features/settings/domain/usecases/save_treanings_settings.dart'
    as _i183;
import 'features/settings/presentation/cubit/settings_cubit.dart' as _i185;
...
import 'features/traveling/domain/usecases/get_planed_travels_usecase.dart'
    as _i129;
import 'features/traveling/domain/usecases/get_travels_usecase.dart' as _i137;
...
import 'features/trekking/domain/usecases/current_trekking_path_usecase.dart'
    as _i97;
import 'features/trekking/domain/usecases/get_trekking_regions.dart' as _i138;
import 'features/trekking/domain/usecases/get_treks.dart' as _i139;
import 'features/trekking/domain/usecases/previos_trekking_path_usecase.dart'
    as _i174;
import 'features/trekking/domain/usecases/start_trek_usecase.dart' as _i186;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i109.EditDayLineUsecase>(
      () => _i109.EditDayLineUsecase(gh<_i63.TravelRepository>()));
  gh.lazySingleton<_i110.EditInsuranceLineUsecase>(
      () => _i110.EditInsuranceLineUsecase(gh<_i63.TravelRepository>()));
  gh.lazySingleton<_i111.EditTechniqueItemUseCase>(() =>
      _i111.EditTechniqueItemUseCase(gh<_i55.TechniqueTreaningsRepository>()));
  gh.lazySingleton<_i112.FinishRockAttempt>(
      () => _i112.FinishRockAttempt(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i113.FinishRockTreaning>(
      () => _i113.FinishRockTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i114.FinishStrengthTreaning>(() =>
      _i114.FinishStrengthTreaning(
          strengthTreaningsRepository: gh<_i51.StrengthTreaningsRepository>()));
  gh.lazySingleton<_i115.FinishTechniqueTreaningUseCase>(() =>
      _i115.FinishTechniqueTreaningUseCase(
          gh<_i55.TechniqueTreaningsRepository>()));
  gh.lazySingleton<_i116.GetBudgetLinesUsecase>(
      () => _i116.GetBudgetLinesUsecase(gh<_i63.TravelRepository>()));
  gh.lazySingleton<_i117.GetCardioTreanings>(() => _i117.GetCardioTreanings(
      cardioTreaningsRepository: gh<_i88.CardioTreaningsRepository>()));
  gh.lazySingleton<_i118.GetClimbingHallRoures>(
      () => _i118.GetClimbingHallRoures(gh<_i90.ClimbingHallRepository>()));
  gh.lazySingleton<_i119.GetCostLinesUsecase>(
      () => _i119.GetCostLinesUsecase(gh<_i63.TravelRepository>()));
  gh.lazySingleton<_i120.GetCurrentRockTreaning>(
      () => _i120.GetCurrentRockTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i121.GetCurrentStrengthTreaning>(() =>
      _i121.GetCurrentStrengthTreaning(
          strengthTreaningsRepository: gh<_i51.StrengthTreaningsRepository>()));
  gh.lazySingleton<_i122.GetDayLinesUsecase>(
      () => _i122.GetDayLinesUsecase(gh<_i63.TravelRepository>()));
  gh.lazySingleton<_i123.GetInsuranceLineUsecase>(
      () => _i123.GetInsuranceLineUsecase(gh<_i63.TravelRepository>()));
  gh.lazySingleton<_i124.GetLastCardioTreaning>(() =>
      _i124.GetLastCardioTreaning(
          cardioTreaningsRepository: gh<_i88.CardioTreaningsRepository>()));
  gh.lazySingleton<_i125.GetLastRockTreaning>(
      () => _i125.GetLastRockTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i126.GetMountainRegions>(
      () => _i126.GetMountainRegions(gh<_i20.MountainRegionsRepository>()));
  gh.lazySingleton<_i127.GetMountainRoutes>(
      () => _i127.GetMountainRoutes(gh<_i20.MountainRegionsRepository>()));
  gh.lazySingleton<_i128.GetMountains>(
      () => _i128.GetMountains(gh<_i20.MountainRegionsRepository>()));
  gh.lazySingleton<_i129.GetPlanedTravelsUsecase>(
      () => _i129.GetPlanedTravelsUsecase(gh<_i63.TravelRepository>()));
  gh.lazySingleton<_i130.GetPreviosStrengthTreaning>(() =>
      _i130.GetPreviosStrengthTreaning(
          strengthTreaningsRepository: gh<_i51.StrengthTreaningsRepository>()));
  gh.lazySingleton<_i131.GetRockRouteAttempts>(
      () => _i131.GetRockRouteAttempts(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i132.GetRockRouteStatistic>(
      () => _i132.GetRockRouteStatistic(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i133.GetStrengthExercises>(() => _i133.GetStrengthExercises(
      strengthExerciseRepository: gh<_i47.StrengthExerciseRepository>()));
  gh.lazySingleton<_i134.GetStrengthTreanings>(() => _i134.GetStrengthTreanings(
      strengthTreaningsRepository: gh<_i51.StrengthTreaningsRepository>()));
  gh.lazySingleton<_i135.GetTechniqueGroupsUsecase>(
      () => _i135.GetTechniqueGroupsUsecase(gh<_i59.TechniquesRepository>()));
  gh.lazySingleton<_i136.GetTechniquesUsecase>(
      () => _i136.GetTechniquesUsecase(gh<_i59.TechniquesRepository>()));
  gh.lazySingleton<_i137.GetTravelsUsecase>(
      () => _i137.GetTravelsUsecase(gh<_i63.TravelRepository>()));
  gh.lazySingleton<_i138.GetTrekkingRegions>(
      () => _i138.GetTrekkingRegions(gh<_i71.TrekkingRepository>()));
  gh.lazySingleton<_i139.GetTreks>(
      () => _i139.GetTreks(gh<_i71.TrekkingRepository>()));
  gh.lazySingleton<_i140.HallRouteToArchive>(() =>
      _i140.HallRouteToArchive(repository: gh<_i90.ClimbingHallRepository>()));
  gh.lazySingleton<_i141.HallTreaningDataSource>(
      () => _i142.LocalHallTreaningDataSource(gh<_i14.LocalDBDatasource>()));
  gh.lazySingleton<_i143.HallTreaningRepository>(
      () => _i144.HallTreaningRepositoryImpl(
            dataSource: gh<_i141.HallTreaningDataSource>(),
            hallDataSource: gh<_i3.ClimbingHallDataSource>(),
          ));
  gh.lazySingleton<_i145.IceRegionsRepository>(
      () => _i146.IceRegionsRepositoryImpl(
            gh<_i9.IceRegionsDataSource>(),
            gh<_i11.IceRegionsRemoteDataSource>(),
            gh<_i22.NetworkInfo>(),
          ));
  gh.lazySingleton<_i147.IceTreaningsDataSource>(
      () => _i148.LocalIceTreaningsDataSource(gh<_i14.LocalDBDatasource>()));
  gh.lazySingleton<_i149.IceTreaningsRepository>(() =>
      _i150.IceTreaningsRepositoryImpl(gh<_i147.IceTreaningsDataSource>()));
  gh.lazySingleton<_i151.LastHallTreaning>(
      () => _i151.LastHallTreaning(gh<_i143.HallTreaningRepository>()));
  gh.lazySingleton<_i152.LoadDistrictsUseCase>(() => _i152.LoadDistrictsUseCase(
      iceRegionsRepository: gh<_i145.IceRegionsRepository>()));
  gh.lazySingleton<_i153.LoadPlaces>(
      () => _i153.LoadPlaces(gh<_i27.PlacesRepository>()));
  gh.lazySingleton<_i154.LoadRockDistricts>(
      () => _i154.LoadRockDistricts(gh<_i35.RockRegionsRepository>()));
  gh.lazySingleton<_i155.LoadRockRoutes>(
      () => _i155.LoadRockRoutes(gh<_i35.RockRegionsRepository>()));
  gh.lazySingleton<_i156.LoadRockSectors>(
      () => _i156.LoadRockSectors(gh<_i35.RockRegionsRepository>()));
  gh.lazySingleton<_i157.LoadSectorsUseCase>(() => _i157.LoadSectorsUseCase(
      iceRegionsRepository: gh<_i145.IceRegionsRepository>()));
  gh.lazySingleton<_i158.LoadSimpleSettingsUsecase>(
      () => _i158.LoadSimpleSettingsUsecase(gh<_i43.SettingsRepository>()));
  gh.lazySingleton<_i159.LoadTreaningsSettings>(
      () => _i159.LoadTreaningsSettings(gh<_i43.SettingsRepository>()));
  gh.lazySingleton<_i160.LocalAscensionDataSource>(
      () => _i161.DriftLocalAscensionDataSource(gh<_i14.LocalDBDatasource>()));
  gh.factory<_i162.MountainRegionsCubit>(
      () => _i162.MountainRegionsCubit(gh<_i126.GetMountainRegions>()));
  gh.factory<_i163.MountainRoutesCubit>(
      () => _i163.MountainRoutesCubit(gh<_i127.GetMountainRoutes>()));
  gh.factory<_i164.MountainsCubit>(
      () => _i164.MountainsCubit(gh<_i128.GetMountains>()));
  gh.lazySingleton<_i165.NewHallAttempt>(() => _i165.NewHallAttempt(
      treaningRepository: gh<_i143.HallTreaningRepository>()));
  gh.lazySingleton<_i166.NewHallAttemptFromRoute>(() =>
      _i166.NewHallAttemptFromRoute(
          hallTreaningRepository: gh<_i143.HallTreaningRepository>()));
  gh.lazySingleton<_i167.NewHallRoute>(() => _i167.NewHallRoute(
      climbingHallRepository: gh<_i90.ClimbingHallRepository>()));
  gh.lazySingleton<_i168.NewHallTreaning>(() => _i168.NewHallTreaning(
      treaningRepository: gh<_i143.HallTreaningRepository>()));
  gh.lazySingleton<_i169.NewIceAttempt>(
      () => _i169.NewIceAttempt(gh<_i149.IceTreaningsRepository>()));
  gh.lazySingleton<_i170.NewIceTreaning>(() => _i170.NewIceTreaning(
        iceTreaningsRepository: gh<_i149.IceTreaningsRepository>(),
        iceRegionsRepository: gh<_i145.IceRegionsRepository>(),
      ));
  gh.lazySingleton<_i171.NewRockAttempt>(
      () => _i171.NewRockAttempt(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i172.NewRockTreaning>(
      () => _i172.NewRockTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.lazySingleton<_i173.PreviosTechniqueTreaningUseCase>(() =>
      _i173.PreviosTechniqueTreaningUseCase(
          gh<_i55.TechniqueTreaningsRepository>()));
  gh.lazySingleton<_i174.PreviosTrekkingPathUsecase>(() =>
      _i174.PreviosTrekkingPathUsecase(gh<_i67.TrekkingPathRepository>()));
  gh.factory<_i175.RockDistrictsCubit>(
      () => _i175.RockDistrictsCubit(gh<_i154.LoadRockDistricts>()));
  gh.factory<_i176.RockRoutesCubit>(() => _i176.RockRoutesCubit(
        gh<_i155.LoadRockRoutes>(),
        gh<_i132.GetRockRouteStatistic>(),
      ));
  gh.lazySingleton<_i177.RockSectorToTreaning>(
      () => _i177.RockSectorToTreaning(gh<_i39.RockTreaningsRepository>()));
  gh.factory<_i178.RockSectorsCubit>(
      () => _i178.RockSectorsCubit(gh<_i156.LoadRockSectors>()));
  gh.factory<_i179.RockTreaningCubit>(() => _i179.RockTreaningCubit(
        gh<_i172.NewRockTreaning>(),
        gh<_i177.RockSectorToTreaning>(),
        gh<_i171.NewRockAttempt>(),
        gh<_i112.FinishRockAttempt>(),
        gh<_i113.FinishRockTreaning>(),
        gh<_i125.GetLastRockTreaning>(),
        gh<_i120.GetCurrentRockTreaning>(),
        gh<_i132.GetRockRouteStatistic>(),
        gh<_i103.DeleteRockAttempt>(),
      ));
  gh.lazySingleton<_i180.SaveCardioTreaning>(() => _i180.SaveCardioTreaning(
      cardioTreaningsRepository: gh<_i88.CardioTreaningsRepository>()));
  gh.lazySingleton<_i181.SaveSimpleSettingsUsecase>(
      () => _i181.SaveSimpleSettingsUsecase(gh<_i43.SettingsRepository>()));
  gh.lazySingleton<_i182.SaveStrengthExercise>(() => _i182.SaveStrengthExercise(
      strengthExerciseRepository: gh<_i47.StrengthExerciseRepository>()));
  gh.lazySingleton<_i183.SaveTreaningsSettings>(
      () => _i183.SaveTreaningsSettings(gh<_i43.SettingsRepository>()));
  gh.lazySingleton<_i184.SelectToUseStrengthExercise>(() =>
      _i184.SelectToUseStrengthExercise(
          strengthExerciseRepository: gh<_i47.StrengthExerciseRepository>()));
  gh.lazySingleton<_i185.SettingsCubit>(() => _i185.SettingsCubit(
        gh<_i159.LoadTreaningsSettings>(),
        gh<_i183.SaveTreaningsSettings>(),
        gh<_i153.LoadPlaces>(),
        gh<_i158.LoadSimpleSettingsUsecase>(),
        gh<_i181.SaveSimpleSettingsUsecase>(),
      ));
  gh.lazySingleton<_i186.StartTrekUsecase>(
      () => _i186.StartTrekUsecase(gh<_i67.TrekkingPathRepository>()));
  gh.factory<_i187.StrengthExercisesCubit>(() => _i187.StrengthExercisesCubit(
        gh<_i133.GetStrengthExercises>(),
        gh<_i182.SaveStrengthExercise>(),
        gh<_i184.SelectToUseStrengthExercise>(),
        gh<_i104.DeleteStrengthExercise>(),
      ));
  gh.factory<_i188.StrengthTrainingCubit>(() => _i188.StrengthTrainingCubit(
        getCurrentStrengthTreaning: gh<_i121.GetCurrentStrengthTreaning>(),
        getPreviosStrengthTreaning: gh<_i130.GetPreviosStrengthTreaning>(),
        ...
        finishStrengthTreaning: gh<_i114.FinishStrengthTreaning>(),
        deleteRepetitionForStrengthTreaning:
            gh<_i102.DeleteRepetitionForStrengthTreaning>(),
      ));
  gh.factory<_i189.StrengthTrainingsCubit>(() => _i189.StrengthTrainingsCubit(
        gh<_i134.GetStrengthTreanings>(),
        gh<_i105.DeleteStrengthTreaning>(),
      ));
  gh.factory<_i190.TechniqueGroupsCubit>(
      () => _i190.TechniqueGroupsCubit(gh<_i135.GetTechniqueGroupsUsecase>()));
  gh.factory<_i191.TechniqueTreaningCubit>(() => _i191.TechniqueTreaningCubit(
        gh<_i77.AddTechniqueTreaningUseCase>(),
        gh<_i173.PreviosTechniqueTreaningUseCase>(),
        gh<_i95.CurrentTechniqueTreaningUseCase>(),
        gh<_i76.AddTechniqueToTreaningUseCase>(),
        gh<_i115.FinishTechniqueTreaningUseCase>(),
        gh<_i111.EditTechniqueItemUseCase>(),
      ));
  gh.factory<_i192.TechniquesCubit>(
      () => _i192.TechniquesCubit(gh<_i136.GetTechniquesUsecase>()));
  gh.factory<_i193.TravelDayCubit>(
      () => _i193.TravelDayCubit(gh<_i109.EditDayLineUsecase>()));
  gh.factory<_i194.TravelPageCubit>(() => _i194.TravelPageCubit(
        gh<_i100.DeleteCostLineUsecase>(),
        gh<_i108.EditCostLineUsecase>(),
        gh<_i119.GetCostLinesUsecase>(),
        gh<_i123.GetInsuranceLineUsecase>(),
        gh<_i116.GetBudgetLinesUsecase>(),
        gh<_i110.EditInsuranceLineUsecase>(),
        gh<_i107.EditBudgetLineUsecase>(),
        gh<_i101.DeleteInsuranceLineUsecase>(),
        gh<_i98.DeleteBudgetLineUsecase>(),
        gh<_i122.GetDayLinesUsecase>(),
      ));
  gh.factory<_i195.TravelsCubit>(() => _i195.TravelsCubit(
        gh<_i137.GetTravelsUsecase>(),
        gh<_i129.GetPlanedTravelsUsecase>(),
        gh<_i78.AddTravelUsecase>(),
      ));
  gh.factory<_i196.TrekkingCubit>(() => _i196.TrekkingCubit(
        gh<_i97.CurrentTrekkingPathUsecase>(),
        gh<_i174.PreviosTrekkingPathUsecase>(),
        gh<_i186.StartTrekUsecase>(),
        gh<_i79.AddTrekEventUsecase>(),
        gh<_i92.ContinueTrekUsecase>(),
      ));
  gh.factory<_i197.TrekkingRegionsCubit>(
      () => _i197.TrekkingRegionsCubit(gh<_i138.GetTrekkingRegions>()));
  gh.factory<_i198.TreksCubit>(() => _i198.TreksCubit(gh<_i139.GetTreks>()));
  gh.lazySingleton<_i199.AllClimbingHalls>(
      () => _i199.AllClimbingHalls(gh<_i90.ClimbingHallRepository>()));
  gh.lazySingleton<_i200.AllHallTreanings>(
      () => _i200.AllHallTreanings(gh<_i143.HallTreaningRepository>()));
  gh.lazySingleton<_i201.AscensionRepository>(() =>
      _i202.AscensionRepositoryImpl(gh<_i160.LocalAscensionDataSource>()));
  gh.factory<_i203.AuthGetUser>(
      () => _i203.AuthGetUser(authRepository: gh<_i84.AuthRepository>()));
  gh.factory<_i204.AuthLogin>(
      () => _i204.AuthLogin(authRepository: gh<_i84.AuthRepository>()));
  gh.factory<_i205.AuthLogout>(
      () => _i205.AuthLogout(authRepository: gh<_i84.AuthRepository>()));
  ...
  gh.lazySingleton<_i210.CurrentHallTreaning>(
      () => _i210.CurrentHallTreaning(gh<_i143.HallTreaningRepository>()));
  ...
  gh.lazySingleton<_i214.DeleteIceAttempt>(
      () => _i214.DeleteIceAttempt(gh<_i149.IceTreaningsRepository>()));
  gh.lazySingleton<_i215.DeleteTreaning>(() => _i215.DeleteTreaning(
        gh<_i143.HallTreaningRepository>(),
        gh<_i149.IceTreaningsRepository>(),
  ...
  gh.lazySingleton<_i220.FinishIceAttempt>(
      () => _i220.FinishIceAttempt(gh<_i149.IceTreaningsRepository>()));
  ...
  gh.lazySingleton<_i225.GetGymRouteStatistic>(
      () => _i225.GetGymRouteStatistic(gh<_i143.HallTreaningRepository>()));
  gh.lazySingleton<_i226.GetHallRouteAttempts>(() => _i226.GetHallRouteAttempts(
      repository: gh<_i143.HallTreaningRepository>()));
  ...
  gh.factory<_i229.HallRouteCubit>(
      () => _i229.HallRouteCubit(gh<_i167.NewHallRoute>()));
  ...
  gh.factory<_i232.IceDistrictsCubit>(() => _i232.IceDistrictsCubit(
      loadDistrictsUseCase: gh<_i152.LoadDistrictsUseCase>()));
  ...
  gh.factory<_i234.IceSectorsCubit>(() => _i234.IceSectorsCubit(
      loadSectorsUseCase: gh<_i157.LoadSectorsUseCase>()));
  ...
  gh.factory<_i238.ClimbingHallCubit>(() => _i238.ClimbingHallCubit(
        gh<_i118.GetClimbingHallRoures>(),
        gh<_i140.HallRouteToArchive>(),
        gh<_i225.GetGymRouteStatistic>(),
      ));
  gh.factory<_i239.CurrentHallTreaningCubit>(
      () => _i239.CurrentHallTreaningCubit(
            newHallAttemptFromRoute: gh<_i166.NewHallAttemptFromRoute>(),
            newHallTreaning: gh<_i168.NewHallTreaning>(),
            newHallAttempt: gh<_i165.NewHallAttempt>(),
            ...
            lastHallTreaning: gh<_i151.LastHallTreaning>(),
  ...
  gh.factory<_i240.CurrentIceTreaningCubit>(() => _i240.CurrentIceTreaningCubit(
        gh<_i170.NewIceTreaning>(),
        gh<_i233.IceSectorToTreaning>(),
        gh<_i169.NewIceAttempt>(),

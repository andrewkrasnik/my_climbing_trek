...
@LazySingleton()
class SaveTrekkingPathUsecase {
  final TrekkingPathRepository _trekkingPathRepository;

  SaveTrekkingPathUsecase(this._trekkingPathRepository);

  Future<Either<Failure, Unit>> call({required TrekkingPath path}) async {
    return _trekkingPathRepository.savePath(path: path);
  }
}

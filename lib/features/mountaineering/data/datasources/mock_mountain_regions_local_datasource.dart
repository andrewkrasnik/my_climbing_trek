  ...
  final Map<Mountain, List<MountainRoute>> _routes = {
    ...
    kilimanjaro: [
      MountainRoute(
        ...
        links: const [
          'https://pohod-v-gory.com/ru/marshruty-na-kilimandzharo/'
        ],
      ),
      MountainRoute(
        category: MountaineeringCategory.oneB,
